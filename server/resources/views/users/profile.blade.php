...
<div class="p-side-origin">
    ...
    <div class="col-sm-9">
        <div class="profile-card card mt-4">
            <div class="card-body  flex-row ml-5 mr-5">
                <p class="float-right "><a href="{{ route('users.edit_profile') }}" class="btn btn-outline-primary wf-mplus1p">プロフィールを編集</a></p>
                <i class="fas fa-user-circle fa-6x mr-1 "></i>
                <a href="{{ route('users.edit_profile') }}" class="text-dark wf-mplus1p d-flex align-items-end">
            ...
            <div class="profile-card card  mt-4">
                ...
                <div class="mt-5 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <a class="h4 " href=# ><i class="fas fa-user-circle pr-2"></i>{{ $current_user_name }} さん</a>
